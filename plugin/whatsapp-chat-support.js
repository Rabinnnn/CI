 ...
 * ====================================================================== */    
    ...
    WhatsappChatSupport.DEFAULTS = {
        ...
        timezone                    :   'Kenya/Nairobi', // When using the date and time from the user browser you can transform it to your current timezone (in case your user is in a different timezone)
        ...
        defaultMsg                  :   'Hi, I have some questions about your Organisation: {{url}}!', // default support msg
